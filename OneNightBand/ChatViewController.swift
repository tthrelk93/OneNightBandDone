...
final class ChatViewController: JSQMessagesViewController, SessionIDDest {
    ...
    override func viewDidLoad() {
        ...
        self.sessionRef = Database.database().reference().child("sessions").child(thisSessionID)
        self.userIsTypingRef = self.sessionRef!.child("typingIndicator").child(self.senderId)
